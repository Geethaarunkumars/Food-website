...
import img1 from "../image/m.png"
import img2 from "../image/pi1.png"
import img3 from "../image/mas.png"
import img4 from "../image/mash.png"
import img5 from "../image/mashr.png"
import img6 from "../image/mashro.png"
import img7 from "../image/mashroo.png"
import img8 from "../image/mashroom.png"
            ...
            <div className="cardsaa">
               ...
               Rs:250
                 ...
                 <button className="btn2">{b}</button>
                  ...
                  <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
                  <Card.Img className="cma" variant="top" src={img4} height={250}/>
                  <CardHeader className="chs">
                  Mashroom Pizza
               ...
               Rs:250
                 ...
                 <button className="btn2">{d}</button>
                  ...
                  <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
                  <Card.Img className="cma" variant="top" src={img6}  height={250}/>
                  <CardHeader className="chs">
                  Mashroom Pizza
               ...
               Rs:250
                 ...
                 <button className="btn2">{f}</button>
                  ...
                  <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
                  <Card.Img className="cmaa" variant="top" src={img8}  height={250} />
                  <CardHeader className="chs">
                  Mashroom Pizza
