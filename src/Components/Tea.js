...
import "./Tomato.css"
import img1 from "../image/tea (1).png"
import img2 from "../image/tea (2).png"
import img3 from "../image/tea (3).png"
import img4 from "../image/tea (4).png"
import img5 from "../image/tea (5).png"
import img6 from "../image/tea (6).png"
import img7 from "../image/tea (1).png"
import img8 from "../image/tea (3).png"
      ...
      <h1>Iced Tea</h1>
           ...
           <div className="cards">
             ...
             <button className="btn2">{c}</button>
              ...
              <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
              <Card.Img className="cm" variant="top" src={img5}  height={250}/>
              <CardHeader className="chs">
              Iced Tea
              </CardHeader>
              <p className="par">
