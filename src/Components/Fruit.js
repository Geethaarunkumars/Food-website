...
import "./Tomato.css"
import img1 from "../image/fruit (1).png"
import img2 from "../image/fruit (2).png"
import img3 from "../image/fruit (3).png"
import img4 from "../image/fruit (4).png"
import img5 from "../image/fruit (5).png"
import img6 from "../image/fruit (6).png"
import img7 from "../image/fruit (7).png"
import img8 from "../image/fruit (1).png"
      ...
      <h1> Fruit Juice</h1>
           ...
           <div className="cards">
             ...
             <button className="btn2">{n}</button>
              ...
              <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
              <Card.Img className="cm" variant="top" src={img2}height={250} />
              <CardHeader className="chs">
              Fruit juice
              </CardHeader>
              <p className="par">
