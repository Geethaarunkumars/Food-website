...
import "./Tomato.css"
import img1 from "../image/soft (1).png"
import img2 from "../image/soft (2).png"
import img3 from "../image/soft (3).png"
import img4 from "../image/soft (4).png"
import img5 from "../image/soft (5).png"
import img6 from "../image/soft (6).png"
import img7 from "../image/soft (2).png"
import img8 from "../image/soft (1).png"
      ...
      <h1> Soft Drinks</h1>
           ...
           <div className="cards">
             ...
             <button className="btn2">{a}</button>
              ...
              <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
              <Card.Img className="cm" variant="top" src={img3} height={250} />
              <CardHeader className="chs">
              Soft Drinks
              </CardHeader>
              <p className="par">
             ...
             <button className="btn2">{b}</button>
              ...
              <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
              <Card.Img className="cm" variant="top" src={img4} height={400}/>
              <CardHeader className="chs">
              Soft Drinks
              </CardHeader>
              <p className="par">
             ...
             <button className="btn2">{d}</button>
              ...
              <Card  className="card2"style={{ width: '18rem', height:'400px' }}>
              <Card.Img className="cm" variant="top" src={img6}  height={300}/>
              <CardHeader className="chs">
              Soft Drinks
              </CardHeader>
              <p className="par">
